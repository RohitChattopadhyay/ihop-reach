    ...
    <Layout>
      <div className="container my-4">
        ...
        <div>
          ...
          <div>
            <p className="lead">
              ...
              biomedical literature. We index over 3million sentences extracted
              using Natural Language Processing of articles present in PubMed
              Central repository.
            </p>
          </div>
        </div>
        ...
        <div>
          ...
          <div>
            <p className="lead">
              By default, searh is set to prepend and append wildcards to the
              searched term. It can tolerate one edit distance to match the
              query to prevent typographic error.
            </p>
            <p>
              For example:
              <br />
