...
def extractFromXML(fileContent):
    ...
    if(os.path.isfile(destFileName)):
        ...
        print("Journal Title,Year,DOI,PMCID,PMID,Article Type", file=destCSV)
    ...
    for art_ix, pm_article in enumerate(pm_articles):
        ...
        try:
            ...
            pubType = parser._find_elem_text(medline_citation.find('./PublicationTypeList'),'PublicationType')            
        ...
        # storing in csv file 
        writer.writerow([title,Year,DOI,PMCID,PMID,article_type])
    # Closing file
    destCSV.close()
